...
function addSubject() {
  ...
  if (editIndex !== -1) {
    subjects[editIndex] = { subject: subjectInput.value, codes, grade, credit };
    editIndex = -1;
  } else {
    subjects.push({ subject: subjectInput.value, codes, grade, credit });
  }
...
function editSubject(index) {
  ...
  document.getElementById("codes").value = selectedSubject.codes;
...
function clearForm() {
  ...
  document.getElementById("grade").value = "Enter_Grade";
